...
void Init_alpm_handler(void){
  ...
  RB_HANDLER_ACCESS_SET(logfile);
  RB_HANDLER_ACCESS_SET(gpgdir);
...
RB_HANDLER_SIMPLE_GETTER_STRING(logfile);
RB_HANDLER_SIMPLE_GETTER_STRING(gpgdir);
RB_HANDLER_SIMPLE_GETTER_STRING(arch);
RB_HANDLER_SIMPLE_GETTER_STRING(dbext);

RB_HANDLER_SIMPLE_SETTER_STRING(logfile);
RB_HANDLER_SIMPLE_SETTER_STRING(gpgdir);
